...
connection.connect();
var getCharacterPageName = function () { return __awaiter(void 0, void 0, void 0, function () {
    var url, data, $, categories, characterPageNames, i, ul, characterLIs, j, li, path, name_1;
...
var getCharacterInfo = function (chaacterName) { return __awaiter(void 0, void 0, void 0, function () {
    var baseUrl, data, $, name, species, image, characterInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                baseUrl = "https://throneofglass.fandom.com/wiki/" + chaacterName;
...
var loadCharacter = function () { return __awaiter(void 0, void 0, void 0, function () {
    var characterPageNames, characterInfoPromises, characters, values, sql;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getCharacterPageName()];
            case 1:
            ...
            case 2:
                ...
                connection.query(sql, [values], function (err) {
                    if (err) {
                        ...
                        console.log('Yyyyy DB is populated............');
                });
                return [2 /*return*/];
        }
    });
